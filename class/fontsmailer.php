 ...
 */
include_once (dirname(__FILE__).'/mail/stillsmultimailer.php');

/**
 * Class for sending mail.
 *
 * Changed to use the facilities of  {@link StillsMultiMailer}
 *
 * @package class
 * @subpackage mail
...
{
    /**
     * reference to a {@link StillsMultiMailer}
     *
     * @var StillsMultiMailer
     * @access private
     ...
     * @return StillsMailer
     */
    function StillsMailer($from, $fromname, $method = 'mail')
    {
        $this->multimailer = new StillsMultiMailer($from, $fromname, $method);
        $this->reset();
        $this->from = $from;
     ...
     * Send email
     *
     * Uses the new StillsMultiMailer
     *
     * @param string $
     * @param string $
     * @param string $
